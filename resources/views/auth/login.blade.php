...
<head>
    ...
    <meta name="author" content="artono_dr">

    <title>ADR Finance Monitor | Login</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @enderror
                                    ...
                                    <form class="user" method="POST" action="{{ route('web.login.gas') }}">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email" name="user_email" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Enter Email Address..." value="{{ old('user_email') }}" autocomplete="on" required>
                                        </div>
                                        <div class="form-group">
